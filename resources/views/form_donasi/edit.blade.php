                    ...
                    <div class="card-body">
                        <form action="{{ route('form_donasi.update', $form_donasi->id) }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="no_tlp" value="{{ $form_donasi->no_tlp }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="nominal" value="{{ $form_donasi->nominal }}"
                            ...
                            <select name="nama_bank" id="nama_bank" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="no_rek" value="{{ $form_donasi->no_rek }}"
